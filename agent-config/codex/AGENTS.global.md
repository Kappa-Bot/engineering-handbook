...
- Owner-default routing under authorized pods is `parent = Sol xhigh`, `design-quality = Astra xhigh`, `delivery = Terra ultra`. Record actual runtime values truthfully if an alias/effort is unavailable.
